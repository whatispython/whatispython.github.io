...
module.exports = "<div class=\"ui vertical basic blog loading segment\">\r\n  <div class=\"ui two column stackable grid\">\r\n    <div class=\"column\" *ngFor=\"let blog of allBlog\" (click)=\"showBlogDetail(blog)\">\r\n      <div class=\"ui raised segment\">\r\n        <div class=\"ui red ribbon label\">{{blog.cat}}</div>\r\n        <div class=\"item\">\r\n          <div class=\"content\">\r\n            <h3></h3>\r\n            <h3 class=\"ui red header\">{{blog.title}}</h3>\r\n            <div class=\"meta\">\r\n              {{blog.ptime | date: 'yyyy-MM-dd HH:mm'}}\r\n            </div>\r\n            <div class=\"description\">\r\n              <p [innerHTML]=\"blog.content\" class=\"rich-content\"></p>\r\n            </div>\r\n            <div class=\"extra\">\r\n              <div class=\"ui image red label\">\r\n                <img src=\"https://api.adorable.io/avatars/285/{{blog.from}}.png\">{{blog.authorInfo.name}}\r\n              </div>\r\n              <div class=\"ui basic red label\"><i class=\"dollar sign icon\"></i>{{blog.value/1000000000000000000}}NAS</div>\r\n              <div class=\"ui basic red label\">\r\n                <i class=\"comment outline icon\"></i>{{blog.payItems.length}}\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n\r\n\r\n\r\n"
...
module.exports = "<div class=\"ui vertical basic blog loading segment\">\r\n  <div class=\"ui two column stackable grid\" *ngIf=\"allBlog && allBlog.length\">\r\n    <div class=\"column\" *ngFor=\"let blog of allBlog\" (click)=\"showBlogDetail(blog)\">\r\n      <div class=\"ui raised segment\">\r\n        <div class=\"ui red ribbon label\">{{blog.cat}}</div>\r\n        <div class=\"item\">\r\n          <div class=\"content\">\r\n            <h3></h3>\r\n            <h3 class=\"ui red header\">{{blog.title}}</h3>\r\n            <div class=\"meta\">\r\n              {{blog.ptime | date: 'yyyy-MM-dd HH:mm'}}\r\n            </div>\r\n            <div class=\"description\">\r\n              <p [innerHTML]=\"blog.content\" class=\"rich-content\"></p>\r\n            </div>\r\n            <div class=\"extra\">\r\n              <div class=\"ui image red label\">\r\n                <img src=\"https://api.adorable.io/avatars/285/{{blog.from}}.png\">{{blog.authorInfo.name}}\r\n              </div>\r\n              <div class=\"ui basic red label\"><i class=\"dollar sign icon\"></i>{{blog.value/1000000000000000000}}NAS</div>\r\n              <div class=\"ui basic red label\">\r\n                <i class=\"comment outline icon\"></i>{{blog.payItems.length}}\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n\r\n    <div class=\"ui grid\" *ngIf=\"allBlog && !allBlog.length\">\r\n      <div class=\"column\">\r\n        <div class=\"ui positive message\">\r\n          <div class=\"header\">\r\n            你还没有发布过博客\r\n          </div>\r\n          <p></p>\r\n          <a class=\"ui red button\" routerLink=\"/post\">去灌水</a>\r\n        </div>\r\n      </div>\r\n    </div>\r\n\r\n\r\n  </div>\r\n\r\n  <div class=\"ui grid\" id=\"extProm\" style=\"display: none\">\r\n    <div class=\"column\">\r\n      <div class=\"ui positive message\">\r\n        <div class=\"header\">\r\n          你还没有安装浏览器插件，安装后再试\r\n        </div>\r\n        <p></p>\r\n        <a class=\"ui red button\" href=\"https://github.com/ChengOrangeJu/WebExtensionWallet\" target=\"_blank\">安装</a>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n"
...
var PostComponent = /** @class */ (function () {
    function PostComponent(blogService, notification, router, userService) {
        ...
        this.userService = userService;
        this.extProm = false;
        this.catNames = ["区块链", ".NET技术", "编程语言", "软件设计", "Web前端", "企业信息化",
